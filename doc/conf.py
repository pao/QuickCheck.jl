...
man_pages = [
    ('index', 'quickcheck.jl', u'QuickCheck.jl Documentation',
     [AUTHORS], 1)
]
...
texinfo_documents = [
  ('index', 'QuickCheck.jl', u'QuickCheck.jl Documentation',
   AUTHORS, 'QuickCheck.jl', 'A Julia implementation of the QuickCheck property-based randomized tester.',
   'Miscellaneous'),
]
